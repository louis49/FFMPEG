...
s.subspec 'FFMPEG' do |ss|
    ss.source_files = 'FFmpeg-iOS-build-script/fat-ffmpeg/include/*.h'
    ss.preserve_paths = 'FFmpeg-iOS-build-script/fat-ffmpeg/lib/*.a'
    ss.library = 'ffmpeg'
    ss.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/FFMPEG/fat-ffmpeg"' }
end

s.subspec 'x264' do |ss|
    ss.source_files = 'FFmpeg-iOS-build-script/fat-x264/include/*.h'
    ss.preserve_paths = 'FFmpeg-iOS-build-script/fat-x264/lib/*.a'
    ss.library = 'x264'
